...
A silver alert may be upgraded to gold in two ways: first, an
...
astronomers to be sent if gold conditions are fulfilled.  Second, any
individual experiment can send an alert message to astronomers on its
own. 

...
previous alarms to be retracted from the server's alarm queues.
...
is GOOD (this case allows an override of past high rate history
...
clients.  \marginpar{\it This documentation currently under construction}
...
\subsection{Alert Email Message}

A message resembling the following will be sent to all
subscribers:
\begin{verbatim}
------------------------------
*** SENDING ALERT ***
...
For the SILVER case, the message goes out only the the SILVER list.

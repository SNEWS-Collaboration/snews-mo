...
\title{SNEWS Operational Mode 3.0}         
...
appropriately. The specific criteria for a GOOD/POSSIBLE/TEST/OVERRIDE alarms
...
\item Specify additional allowed fields in the alarm.
\end{itemize}
